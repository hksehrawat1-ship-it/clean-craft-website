...
import { Check, X, DollarSign, Calculator, Trophy, ShirtIcon, BarChart2, Users, Shield, Clock } from "lucide-react";
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800">Why Buy From Us</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-[#FEFDF5] rounded-lg p-8">
              <div className="flex items-start mb-5">
                ...
                <h3 className="text-2xl font-bold text-gray-800">Built For Your Success</h3>
              </div>
              <p className="text-gray-600">
            ...
            <div className="bg-white rounded-lg p-8">
              <div className="flex items-start mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-800">Real Guarantees in Legal Documents</h3>
              </div>

              <div className="space-y-4">
                <div className="flex items-start">
                  <Check className="w-5 h-5 text-gray-400 mr-3 mt-1 flex-shrink-0" />
                  <p className="text-gray-600">1000 customers in your first year – or we fund your next 6 months of marketing</p>
                </div>
                
                <div className="flex items-start">
                  <Check className="w-5 h-5 text-gray-400 mr-3 mt-1 flex-shrink-0" />
                  <p className="text-gray-600">Store not ready in 30 days? We pay your rent</p>
                </div>
                
                <div className="flex items-start">
                  <Check className="w-5 h-5 text-gray-400 mr-3 mt-1 flex-shrink-0" />
                  <p className="text-gray-600">Don't break even? Get 100% royalty-free for life</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg p-8">
              <div className="flex items-start mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-800">Everything You Need to Succeed</h3>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start">
                  <Check className="w-5 h-5 text-gray-400 mr-3 mt-1 flex-shrink-0" />
                  <p className="text-gray-600">Training that reveals every secret we've learned</p>
                </div>
                
                <div className="flex items-start">
                  <Check className="w-5 h-5 text-gray-400 mr-3 mt-1 flex-shrink-0" />
                  <p className="text-gray-600">Tech and branding designed to convert footfall into loyalty</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800">Why Buy Now</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-white rounded-lg p-8 border-l-4 border-blue-500 relative overflow-hidden">
              ...
              <div className="flex items-start mb-6 mt-8">
                ...
                <h3 className="text-2xl font-bold text-gray-800">Don't Miss Market Opportunities</h3>
              </div>
              <p className="text-gray-600">
            ...
            <div className="bg-white rounded-lg p-8 border-l-4 border-red-500 relative overflow-hidden">
              ...
              <div className="flex items-start mb-6 mt-8">
                ...
                <h3 className="text-2xl font-bold text-gray-800">Best Support Package Available Now</h3>
              </div>
              <p className="text-gray-600">
