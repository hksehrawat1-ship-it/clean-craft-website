...
const CareSection = () => {
  ...
  return (
    <section id="care" className="relative overflow-hidden bg-gradient-to-b from-cleancraft-light via-white to-white">
      <div className="container-custom section-padding">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 animate-fade-in">
            <Badge variant="outline" className="bg-cleancraft-light text-cleancraft-darkgold px-4 py-1.5 text-sm">
              Take Action Now
            </Badge>
            ...
            <div className="bg-white/70 backdrop-blur-sm border border-cleancraft-light rounded-xl p-4 shadow-sm">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h3 className="font-bold text-xl text-google-blue">3-Call Total Deal Close Policy:</h3>
            ...
            <p className="text-lg text-gray-700">
              Both options are acceptable. We respect your decision and are here to support your journey whenever you're ready.
            </p>
            ...
            <div className="flex items-center space-x-4 pt-2">
              ...
              <p className="text-sm text-gray-600">
                <span className="font-semibold bg-yellow-100 px-2 py-1 rounded">Every day you wait, someone else starts</span>
              </p>
            </div>
          </div>
          
          <div className="relative lg:h-[680px] animate-fade-in" style={{ animationDelay: "0.2s" }}>
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <Select onValueChange={field.onChange} defaultValue={field.value}>
                                  ...
                                  <SelectContent>
                                    <SelectGroup>
                                      <SelectItem value="morning" className="flex items-center">
