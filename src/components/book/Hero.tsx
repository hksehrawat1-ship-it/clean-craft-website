        ...
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
          <div className="w-full md:w-1/2 text-center md:text-left">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black leading-tight mb-4">
              <span className="text-primary">SPOTLESS PROFIT</span> <span className="text-gray-900">IN LAUNDRY</span>
            </h1>
            ...
            <p className="text-lg text-gray-700 mb-8">
              Learn the exact <span className="text-primary font-bold">laundry business plan India</span> experts use and discover <span className="font-bold">how much to invest in laundry business</span> for maximum returns. Perfect for entrepreneurs seeking <span className="font-bold">profitable business in India 2025</span>.
            </p>
            <div className="flex items-center justify-center md:justify-start gap-4 mb-4">
              <h3 className="text-2xl font-black text-gray-900">₹479</h3>
              <div className="flex items-center">
                <span className="text-lg text-gray-400 line-through mr-2">₹799</span>
