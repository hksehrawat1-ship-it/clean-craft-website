  ...
  const guaranteesList = [
    {
      ...
      description: "If you attend all sessions and complete the practical assignments, we guarantee you will master all the core laundry techniques—washing, dry cleaning, stain removal, and fabric care."
    },
    {
      id: 2,
      title: "Certificate of Completion Guarantee",
      description: "Every student who completes the course will receive a government-acknowledged or Clean Craft-backed certificate, which adds credibility to your resume or future business."
    },
    {
      id: 3,
      title: "Business Start-Up Support Guarantee",
      description: "After training, we provide a free one-on-one business consultation to help you start your own laundry business."
    },
    {
      id: 4,
      title: "Internship or Live Demo Guarantee",
      description: "You will get to work on real customer clothes in a live store setting before completing the course."
    },
    {
      id: 5,
    ...
    <section id="guarantees" className="py-16 bg-blue-50">
      <div className="container mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">The Clean Craft Guarantee</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            We're committed to your success. Here are our promises to you when you join our training program.
          </p>
        </div>
          ...
          {guaranteesList.map((guarantee) => (
            ...
            >
              <div className="flex-shrink-0">
                <div className="bg-primary rounded-full p-2 inline-flex">
        ...
        <div className="mt-12 text-center">
          <p className="text-lg text-gray-700 max-w-3xl mx-auto">
            Our guarantees reflect our confidence in our training program and our commitment to ensuring you get real value from your investment. We're invested in your success.
          </p>
        </div>
      </div>
    </section>
