...
const EnhancedBlogHero = () => {
  return (
    <section className="relative bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 overflow-hidden">
      ...
      <div className="absolute top-40 right-20 w-24 h-24 bg-blue-400/20 rounded-full animate-float-delayed"></div>
      <div className="absolute bottom-20 left-1/4 w-12 h-12 bg-indigo-300/15 rounded-full animate-float"></div>
