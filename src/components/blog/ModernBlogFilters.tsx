...
const ModernBlogFilters = ({ selectedCategory, onCategorySelect }: ModernBlogFiltersProps) => {
    ...
    <div className="bg-white rounded-2xl shadow-lg border-0 p-6 mb-8">
      ...
      <div className="mt-6 pt-6 border-t border-gray-100">
        ...
        <div className="flex flex-wrap gap-2">
          {["Dry Cleaning", "Stain Removal", "Fabric Care", "Business Tips", "Eco-Friendly"].map((tag) => (
            <Badge 
              key={tag} 
              variant="outline" 
