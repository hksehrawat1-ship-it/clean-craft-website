...
export function SEO({ slug, defaultTitle, defaultDescription }: SEOProps) {
  ...
  const title = seoData?.seo_title || seoData?.title || defaultTitle || 'CleanCraft';
  const description = seoData?.seo_description || defaultDescription || 'Professional laundry services';
