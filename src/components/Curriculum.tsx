          ...
          <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {theoreticalTopics.map((topic, index) => (
                <div key={index} className="bg-white p-3 rounded-lg flex items-center shadow-sm hover:shadow transition-all">
          ...
          <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 p-8">
            ...
            <div className="space-y-4">
              {practicalTopics.map((topic, index) => (
                <div key={index} className="bg-white p-4 rounded-lg shadow-sm hover:shadow transition-all">
        ...
        <div className="mt-12 max-w-6xl mx-auto">
          <Dialog>
            ...
            <DialogContent className="sm:max-w-2xl">
              <DialogHeader>
                <DialogTitle className="text-2xl text-center">Complete Business Setup Guide</DialogTitle>
              </DialogHeader>
              <div className="bg-gradient-to-br from-purple-50 to-blue-50 p-6 rounded-lg space-y-4 mt-4">
                <div className="flex flex-col md:flex-row gap-4 items-start">
                  <div className="bg-white p-4 rounded-lg shadow-sm flex-1">
                    <h4 className="font-bold text-lg text-primary mb-2">Location Selection</h4>
                    <p className="text-gray-600">Learn how to identify prime locations for your laundry business, analyze competition, and estimate foot traffic for maximum profitability.</p>
                  </div>
                  <div className="bg-white p-4 rounded-lg shadow-sm flex-1">
                    <h4 className="font-bold text-lg text-primary mb-2">Equipment Sourcing</h4>
                    <p className="text-gray-600">Get insider knowledge on sourcing quality equipment at wholesale rates, with direct contacts to suppliers across India.</p>
                  </div>
                </div>
                <div className="flex flex-col md:flex-row gap-4 items-start">
                  <div className="bg-white p-4 rounded-lg shadow-sm flex-1">
                    <h4 className="font-bold text-lg text-primary mb-2">Marketing Strategies</h4>
                    <p className="text-gray-600">Discover proven marketing techniques specifically designed for laundry businesses to attract and retain customers.</p>
                  </div>
                  <div className="bg-white p-4 rounded-lg shadow-sm flex-1">
                    <h4 className="font-bold text-lg text-primary mb-2">Operational Best Practices</h4>
                    <p className="text-gray-600">Master the day-to-day operations with efficient workflows, inventory management, and staff training protocols.</p>
                  </div>
                </div>
                <div className="bg-blue-100 p-4 rounded-lg mt-4">
                  <h4 className="font-bold text-center">One-on-One Business Consultation Included</h4>
                  <p className="text-center text-gray-700 mt-2">After completing the training, you'll receive personalized guidance to launch your business successfully.</p>
                </div>
              </div>
            </DialogContent>
          </Dialog>
